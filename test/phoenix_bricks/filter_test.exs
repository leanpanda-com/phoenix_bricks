defmodule PhoenixBricks.FilterTest do
  ...
  describe "using PhoenixBricks.Filter" do
    test "convert_filters_to_scopes/1 returns a list of filters" do
      filters = %{"field_matcher" => "value"}

      assert FilterExample.convert_filters_to_scopes(filters) == [field_matcher: "value"]
    end
